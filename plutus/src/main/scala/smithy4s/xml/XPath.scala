...
/** Represents a path in the XML payload. Segments can be either tags, indexes
  * (when dealing with collections), or attributes.
  *
  * This allows, in particular, to identify which part of the payload is faulty,
  * during decoding.
  */
