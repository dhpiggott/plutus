...
object aliases:
  ...
  /** Type of the callback function used by the apply functions of
    ...
    */
  opaque type CFDictionaryApplierFunction =
    CFuncPtr3[Ptr[Byte], Ptr[Byte], Ptr[Byte], Unit]
  object CFDictionaryApplierFunction:
    given _tag: Tag[CFDictionaryApplierFunction] =
      Tag.materializeCFuncPtr3[Ptr[Byte], Ptr[Byte], Ptr[Byte], Unit]
    inline def fromPtr(ptr: Ptr[Byte] | Ptr[?]): CFDictionaryApplierFunction =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr3[Ptr[Byte], Ptr[Byte], Ptr[Byte], Unit]
    ): CFDictionaryApplierFunction = o
  ...
  /** [bindgen] header:
    * /Library/Developer/CommandLineTools/SDKs/MacOSX15.4.sdk/System/Library/Frameworks/CoreFoundation.framework/Versions/A/Headers/CFDictionary.h
    */
  opaque type CFDictionaryCopyDescriptionCallBack =
    CFuncPtr1[Ptr[Byte], CFStringRef]
  object CFDictionaryCopyDescriptionCallBack:
    given _tag: Tag[CFDictionaryCopyDescriptionCallBack] =
      Tag.materializeCFuncPtr1[Ptr[Byte], CFStringRef]
    inline def fromPtr(
        ptr: Ptr[Byte] | Ptr[?]
    ): CFDictionaryCopyDescriptionCallBack =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr1[Ptr[Byte], CFStringRef]
    ): CFDictionaryCopyDescriptionCallBack = o
  ...
  /** [bindgen] header:
    * /Library/Developer/CommandLineTools/SDKs/MacOSX15.4.sdk/System/Library/Frameworks/CoreFoundation.framework/Versions/A/Headers/CFDictionary.h
    */
  opaque type CFDictionaryEqualCallBack =
    CFuncPtr2[Ptr[Byte], Ptr[Byte], Boolean]
  object CFDictionaryEqualCallBack:
    given _tag: Tag[CFDictionaryEqualCallBack] =
      Tag.materializeCFuncPtr2[Ptr[Byte], Ptr[Byte], Boolean]
    inline def fromPtr(ptr: Ptr[Byte] | Ptr[?]): CFDictionaryEqualCallBack =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr2[Ptr[Byte], Ptr[Byte], Boolean]
    ): CFDictionaryEqualCallBack = o
  ...
  object CFDictionaryHashCallBack:
    given _tag: Tag[CFDictionaryHashCallBack] =
      Tag.materializeCFuncPtr1[Ptr[Byte], CFHashCode]
    inline def fromPtr(ptr: Ptr[Byte] | Ptr[?]): CFDictionaryHashCallBack =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr1[Ptr[Byte], CFHashCode]
    ): CFDictionaryHashCallBack = o
  ...
  /** [bindgen] header:
    * /Library/Developer/CommandLineTools/SDKs/MacOSX15.4.sdk/System/Library/Frameworks/CoreFoundation.framework/Versions/A/Headers/CFDictionary.h
    */
  opaque type CFDictionaryReleaseCallBack =
    CFuncPtr2[CFAllocatorRef, Ptr[Byte], Unit]
  object CFDictionaryReleaseCallBack:
    given _tag: Tag[CFDictionaryReleaseCallBack] =
      Tag.materializeCFuncPtr2[CFAllocatorRef, Ptr[Byte], Unit]
    inline def fromPtr(ptr: Ptr[Byte] | Ptr[?]): CFDictionaryReleaseCallBack =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr2[CFAllocatorRef, Ptr[Byte], Unit]
    ): CFDictionaryReleaseCallBack = o
    extension (v: CFDictionaryReleaseCallBack)
      inline def value: CFuncPtr2[CFAllocatorRef, Ptr[Byte], Unit] = v
      inline def toPtr: Ptr[?] = CFuncPtr.toPtr(v)

  /** Structure containing the callbacks for keys of a CFDictionary. version The
    * version number of the structure type being passed in as a parameter to the
    * CFDictionary creation functions. This structure is version 0. retain The
    * callback used to add a retain for the dictionary on keys as they are used
    * to put values into the dictionary. This callback returns the value to use
    * as the key in the dictionary, which is usually the value parameter passed
    * to this callback, but may be a different value if a different value should
    * be used as the key. The dictionary's allocator is passed as the first
    * argument. release The callback used to remove a retain previously added
    * for the dictionary from keys as their values are removed from the
    * dictionary. The dictionary's allocator is passed as the first argument.
    * copyDescription The callback used to create a descriptive string
    * representation of each key in the dictionary. This is used by the
    * CFCopyDescription() function. equal The callback used to compare keys in
    * the dictionary for equality. hash The callback used to compute a hash code
    * for keys as they are used to access, add, or remove values in the
    * dictionary.
    *
    * [bindgen] header:
    * /Library/Developer/CommandLineTools/SDKs/MacOSX15.4.sdk/System/Library/Frameworks/CoreFoundation.framework/Versions/A/Headers/CFDictionary.h
    */
  opaque type CFDictionaryRetainCallBack =
    CFuncPtr2[CFAllocatorRef, Ptr[Byte], Ptr[Byte]]
  object CFDictionaryRetainCallBack:
    given _tag: Tag[CFDictionaryRetainCallBack] =
      Tag.materializeCFuncPtr2[CFAllocatorRef, Ptr[Byte], Ptr[Byte]]
    inline def fromPtr(ptr: Ptr[Byte] | Ptr[?]): CFDictionaryRetainCallBack =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr2[CFAllocatorRef, Ptr[Byte], Ptr[Byte]]
    ): CFDictionaryRetainCallBack = o
  ...
  object CFHashCode:
    ...
    extension (v: CFHashCode) inline def value: CUnsignedLongInt = v
  ...
  object CFMutableDictionaryRef:
    given _tag: Tag[CFMutableDictionaryRef] =
      Tag.Ptr[__CFDictionary](__CFDictionary._tag)
...
object structs:
  ...
  /** [bindgen] header:
    * /Library/Developer/CommandLineTools/SDKs/MacOSX15.4.sdk/System/Library/Frameworks/CoreFoundation.framework/Versions/A/Headers/CFDictionary.h
    */
  opaque type CFDictionaryKeyCallBacks = CStruct6[
    CFIndex,
  ...
  object CFDictionaryKeyCallBacks:
    given _tag: Tag[CFDictionaryKeyCallBacks] = Tag.materializeCStruct6Tag[
      CFIndex,
      CFDictionaryRetainCallBack,
      CFDictionaryReleaseCallBack,
      CFDictionaryCopyDescriptionCallBack,
    ...
    def apply()(using Zone): Ptr[CFDictionaryKeyCallBacks] =
      scala.scalanative.unsafe.alloc[CFDictionaryKeyCallBacks](1)
    def apply(
        version: CFIndex,
    ...
    )(using Zone): Ptr[CFDictionaryKeyCallBacks] =
      val ____ptr = apply()
    ...
    extension (struct: CFDictionaryKeyCallBacks)
      ...
      def retain_=(value: CFDictionaryRetainCallBack): Unit = !struct.at2 =
        value
      def release: CFDictionaryReleaseCallBack = struct._3
      def release_=(value: CFDictionaryReleaseCallBack): Unit = !struct.at3 =
        value
      def copyDescription: CFDictionaryCopyDescriptionCallBack = struct._4
      def copyDescription_=(value: CFDictionaryCopyDescriptionCallBack): Unit =
        !struct.at4 = value
  ...
  /** Structure containing the callbacks for values of a CFDictionary. version
    * The version number of the structure type being passed in as a parameter to
    * the CFDictionary creation functions. This structure is version 0. retain
    * The callback used to add a retain for the dictionary on values as they are
    * put into the dictionary. This callback returns the value to use as the
    * value in the dictionary, which is usually the value parameter passed to
    * this callback, but may be a different value if a different value should be
    * added to the dictionary. The dictionary's allocator is passed as the first
    * argument. release The callback used to remove a retain previously added
    * for the dictionary from values as they are removed from the dictionary.
    * The dictionary's allocator is passed as the first argument.
    * copyDescription The callback used to create a descriptive string
    * representation of each value in the dictionary. This is used by the
    * CFCopyDescription() function. equal The callback used to compare values in
    * the dictionary for equality in some operations.
    *
    * [bindgen] header:
    * /Library/Developer/CommandLineTools/SDKs/MacOSX15.4.sdk/System/Library/Frameworks/CoreFoundation.framework/Versions/A/Headers/CFDictionary.h
    */
  opaque type CFDictionaryValueCallBacks = CStruct5[
    CFIndex,
    CFDictionaryRetainCallBack,
    CFDictionaryReleaseCallBack,
    CFDictionaryCopyDescriptionCallBack,
  ...
  object CFDictionaryValueCallBacks:
    given _tag: Tag[CFDictionaryValueCallBacks] = Tag.materializeCStruct5Tag[
      CFIndex,
      CFDictionaryRetainCallBack,
      CFDictionaryReleaseCallBack,
      CFDictionaryCopyDescriptionCallBack,
    ...
    def apply()(using Zone): Ptr[CFDictionaryValueCallBacks] =
      scala.scalanative.unsafe.alloc[CFDictionaryValueCallBacks](1)
    def apply(
        version: CFIndex,
        retain: CFDictionaryRetainCallBack,
        release: CFDictionaryReleaseCallBack,
        copyDescription: CFDictionaryCopyDescriptionCallBack,
        equal: CFDictionaryEqualCallBack
    )(using Zone): Ptr[CFDictionaryValueCallBacks] =
      val ____ptr = apply()
      (!____ptr).version = version
      (!____ptr).retain = retain
      (!____ptr).release = release
...
private[cfdictionary] object extern_functions:
  ...
  def CFDictionaryCreate(
      ...
      values: Ptr[Ptr[Byte]],
      numValues: CFIndex,
      keyCallBacks: Ptr[CFDictionaryKeyCallBacks],
      valueCallBacks: Ptr[CFDictionaryValueCallBacks]
  ): CFDictionaryRef = extern

  /** Creates a new immutable dictionary with the key-value pairs from the given
    * dictionary.
    *
    * [bindgen] header:
    * /Library/Developer/CommandLineTools/SDKs/MacOSX15.4.sdk/System/Library/Frameworks/CoreFoundation.framework/Versions/A/Headers/CFDictionary.h
    */
  def CFDictionaryCreateCopy(
      allocator: CFAllocatorRef,
      theDict: CFDictionaryRef
  ): CFDictionaryRef = extern
  ...
  /** Creates a new mutable dictionary with the key-value pairs from the given
    ...
    * /Library/Developer/CommandLineTools/SDKs/MacOSX15.4.sdk/System/Library/Frameworks/CoreFoundation.framework/Versions/A/Headers/CFDictionary.h
    */
  def CFDictionaryCreateMutableCopy(
      allocator: CFAllocatorRef,
      capacity: CFIndex,
      theDict: CFDictionaryRef
  ): CFMutableDictionaryRef = extern
  ...
  /** Counts the number of times the given value occurs in the dictionary.
    ...
    * /Library/Developer/CommandLineTools/SDKs/MacOSX15.4.sdk/System/Library/Frameworks/CoreFoundation.framework/Versions/A/Headers/CFDictionary.h
    */
  def CFDictionaryGetCountOfValue(
      theDict: CFDictionaryRef,
      value: Ptr[Byte]
  ): CFIndex = extern
  ...
  /** Fills the two buffers with the keys and values from the dictionary.
    ...
    * /Library/Developer/CommandLineTools/SDKs/MacOSX15.4.sdk/System/Library/Frameworks/CoreFoundation.framework/Versions/A/Headers/CFDictionary.h
    */
  def CFDictionaryGetKeysAndValues(
      theDict: CFDictionaryRef,
      keys: Ptr[Ptr[Byte]],
      values: Ptr[Ptr[Byte]]
  ): Unit = extern
  ...
  /** Retrieves the value associated with the given key.
    ...
    * /Library/Developer/CommandLineTools/SDKs/MacOSX15.4.sdk/System/Library/Frameworks/CoreFoundation.framework/Versions/A/Headers/CFDictionary.h
    */
  def CFDictionaryGetValueIfPresent(
      theDict: CFDictionaryRef,
      key: Ptr[Byte],
      value: Ptr[Ptr[Byte]]
  ): Boolean = extern
  ...
  /** Removes all the values from the dictionary, making it empty.
    ...
    * /Library/Developer/CommandLineTools/SDKs/MacOSX15.4.sdk/System/Library/Frameworks/CoreFoundation.framework/Versions/A/Headers/CFDictionary.h
    */
  def CFDictionaryRemoveAllValues(theDict: CFMutableDictionaryRef): Unit =
    extern
