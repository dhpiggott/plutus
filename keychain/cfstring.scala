...
object aliases:
  ...
  */
  ...
  /**
   * [bindgen] header: /Library/Developer/CommandLineTools/SDKs/MacOSX15.4.sdk/System/Library/Frameworks/CoreFoundation.framework/Versions/A/Headers/CFString.h
  */
...
private[cfstring] object extern_functions:
  ...
  */
  ...
  private[cfstring] def __sn_wrap_cfstring_CFStringCompareWithOptions(theString1 : CFStringRef, theString2 : CFStringRef, rangeToCompare : Ptr[CFRange], compareOptions : CFStringCompareFlags): CFComparisonResult = extern

  private[cfstring] def __sn_wrap_cfstring_CFStringCompareWithOptionsAndLocale(theString1 : CFStringRef, theString2 : CFStringRef, rangeToCompare : Ptr[CFRange], compareOptions : CFStringCompareFlags, locale : CFLocaleRef): CFComparisonResult = extern

  private[cfstring] def __sn_wrap_cfstring_CFStringCreateArrayWithFindResults(alloc : CFAllocatorRef, theString : CFStringRef, stringToFind : CFStringRef, rangeToSearch : Ptr[CFRange], compareOptions : CFStringCompareFlags): CFArrayRef = extern

  private[cfstring] def __sn_wrap_cfstring_CFStringCreateWithSubstring(alloc : CFAllocatorRef, str : CFStringRef, range : Ptr[CFRange]): CFStringRef = extern

  private[cfstring] def __sn_wrap_cfstring_CFStringDelete(theString : CFMutableStringRef, range : Ptr[CFRange]): Unit = extern

  private[cfstring] def __sn_wrap_cfstring_CFStringFind(theString : CFStringRef, stringToFind : CFStringRef, compareOptions : CFStringCompareFlags, __return : Ptr[CFRange]): Unit = extern

  private[cfstring] def __sn_wrap_cfstring_CFStringFindAndReplace(theString : CFMutableStringRef, stringToFind : CFStringRef, replacementString : CFStringRef, rangeToSearch : Ptr[CFRange], compareOptions : CFStringCompareFlags): CFIndex = extern

  private[cfstring] def __sn_wrap_cfstring_CFStringFindCharacterFromSet(theString : CFStringRef, theSet : CFCharacterSetRef, rangeToSearch : Ptr[CFRange], searchOptions : CFStringCompareFlags, result : Ptr[CFRange]): Boolean = extern

  private[cfstring] def __sn_wrap_cfstring_CFStringFindWithOptions(theString : CFStringRef, stringToFind : CFStringRef, rangeToSearch : Ptr[CFRange], searchOptions : CFStringCompareFlags, result : Ptr[CFRange]): Boolean = extern

  private[cfstring] def __sn_wrap_cfstring_CFStringFindWithOptionsAndLocale(theString : CFStringRef, stringToFind : CFStringRef, rangeToSearch : Ptr[CFRange], searchOptions : CFStringCompareFlags, locale : CFLocaleRef, result : Ptr[CFRange]): Boolean = extern

  private[cfstring] def __sn_wrap_cfstring_CFStringGetBytes(theString : CFStringRef, range : Ptr[CFRange], encoding : CFStringEncoding, lossByte : UInt8, isExternalRepresentation : Boolean, buffer : Ptr[UInt8], maxBufLen : CFIndex, usedBufLen : Ptr[CFIndex]): CFIndex = extern

  private[cfstring] def __sn_wrap_cfstring_CFStringGetCharacters(theString : CFStringRef, range : Ptr[CFRange], buffer : Ptr[UniChar]): Unit = extern

  private[cfstring] def __sn_wrap_cfstring_CFStringGetHyphenationLocationBeforeIndex(string : CFStringRef, location : CFIndex, limitRange : Ptr[CFRange], options : CFOptionFlags, locale : CFLocaleRef, character : Ptr[UTF32Char]): CFIndex = extern

  private[cfstring] def __sn_wrap_cfstring_CFStringGetLineBounds(theString : CFStringRef, range : Ptr[CFRange], lineBeginIndex : Ptr[CFIndex], lineEndIndex : Ptr[CFIndex], contentsEndIndex : Ptr[CFIndex]): Unit = extern

  private[cfstring] def __sn_wrap_cfstring_CFStringGetParagraphBounds(string : CFStringRef, range : Ptr[CFRange], parBeginIndex : Ptr[CFIndex], parEndIndex : Ptr[CFIndex], contentsEndIndex : Ptr[CFIndex]): Unit = extern

  private[cfstring] def __sn_wrap_cfstring_CFStringGetRangeOfComposedCharactersAtIndex(theString : CFStringRef, theIndex : CFIndex, __return : Ptr[CFRange]): Unit = extern

  private[cfstring] def __sn_wrap_cfstring_CFStringInitInlineBuffer(str : CFStringRef, buf : Ptr[CFStringInlineBuffer], range : Ptr[CFRange]): Unit = extern

  private[cfstring] def __sn_wrap_cfstring_CFStringReplace(theString : CFMutableStringRef, range : Ptr[CFRange], replacement : CFStringRef): Unit = extern
...
object functions:
  ...
  */
  def CFStringCompareWithOptions(theString1 : CFStringRef, theString2 : CFStringRef, rangeToCompare : CFRange, compareOptions : CFStringCompareFlags)(using Zone): CFComparisonResult = 
    ...
    __sn_wrap_cfstring_CFStringCompareWithOptions(theString1, theString2, (__ptr_0 + 0), compareOptions)
  ...
  */
  def CFStringCompareWithOptions(theString1 : CFStringRef, theString2 : CFStringRef, rangeToCompare : Ptr[CFRange], compareOptions : CFStringCompareFlags): CFComparisonResult = 
    __sn_wrap_cfstring_CFStringCompareWithOptions(theString1, theString2, rangeToCompare, compareOptions)
  ...
  */
  def CFStringCompareWithOptionsAndLocale(theString1 : CFStringRef, theString2 : CFStringRef, rangeToCompare : CFRange, compareOptions : CFStringCompareFlags, locale : CFLocaleRef)(using Zone): CFComparisonResult = 
    val __ptr_0: Ptr[CFRange] = alloc[CFRange](1)
    !(__ptr_0 + 0) = rangeToCompare
    __sn_wrap_cfstring_CFStringCompareWithOptionsAndLocale(theString1, theString2, (__ptr_0 + 0), compareOptions, locale)
  ...
  */
  def CFStringCompareWithOptionsAndLocale(theString1 : CFStringRef, theString2 : CFStringRef, rangeToCompare : Ptr[CFRange], compareOptions : CFStringCompareFlags, locale : CFLocaleRef): CFComparisonResult = 
    __sn_wrap_cfstring_CFStringCompareWithOptionsAndLocale(theString1, theString2, rangeToCompare, compareOptions, locale)
  ...
  */
  def CFStringCreateArrayWithFindResults(alloc : CFAllocatorRef, theString : CFStringRef, stringToFind : CFStringRef, rangeToSearch : Ptr[CFRange], compareOptions : CFStringCompareFlags): CFArrayRef = 
    __sn_wrap_cfstring_CFStringCreateArrayWithFindResults(alloc, theString, stringToFind, rangeToSearch, compareOptions)

  /**
   * [bindgen] header: /Library/Developer/CommandLineTools/SDKs/MacOSX15.4.sdk/System/Library/Frameworks/CoreFoundation.framework/Versions/A/Headers/CFString.h
  */
  def CFStringCreateArrayWithFindResults(__alloc : CFAllocatorRef, theString : CFStringRef, stringToFind : CFStringRef, rangeToSearch : CFRange, compareOptions : CFStringCompareFlags)(using Zone): CFArrayRef = 
    val __ptr_0: Ptr[CFRange] = alloc[CFRange](1)
    !(__ptr_0 + 0) = rangeToSearch
    __sn_wrap_cfstring_CFStringCreateArrayWithFindResults(__alloc, theString, stringToFind, (__ptr_0 + 0), compareOptions)

  /**
   * [bindgen] header: /Library/Developer/CommandLineTools/SDKs/MacOSX15.4.sdk/System/Library/Frameworks/CoreFoundation.framework/Versions/A/Headers/CFString.h
  */
  def CFStringCreateWithSubstring(__alloc : CFAllocatorRef, str : CFStringRef, range : CFRange)(using Zone): CFStringRef = 
    val __ptr_0: Ptr[CFRange] = alloc[CFRange](1)
    !(__ptr_0 + 0) = range
  ...
  */
  def CFStringFind(theString : CFStringRef, stringToFind : CFStringRef, compareOptions : CFStringCompareFlags)(using Zone): CFRange = 
    val __ptr_0: Ptr[CFRange] = alloc[CFRange](1)
    __sn_wrap_cfstring_CFStringFind(theString, stringToFind, compareOptions, (__ptr_0 + 0))
    !(__ptr_0 + 0)
  ...
  */
  def CFStringFind(theString : CFStringRef, stringToFind : CFStringRef, compareOptions : CFStringCompareFlags)(__return : Ptr[CFRange]): Unit = 
    __sn_wrap_cfstring_CFStringFind(theString, stringToFind, compareOptions, __return)
  ...
  */
  def CFStringFindAndReplace(theString : CFMutableStringRef, stringToFind : CFStringRef, replacementString : CFStringRef, rangeToSearch : Ptr[CFRange], compareOptions : CFStringCompareFlags): CFIndex = 
    __sn_wrap_cfstring_CFStringFindAndReplace(theString, stringToFind, replacementString, rangeToSearch, compareOptions)
  ...
  */
  def CFStringFindAndReplace(theString : CFMutableStringRef, stringToFind : CFStringRef, replacementString : CFStringRef, rangeToSearch : CFRange, compareOptions : CFStringCompareFlags)(using Zone): CFIndex = 
    val __ptr_0: Ptr[CFRange] = alloc[CFRange](1)
    !(__ptr_0 + 0) = rangeToSearch
    __sn_wrap_cfstring_CFStringFindAndReplace(theString, stringToFind, replacementString, (__ptr_0 + 0), compareOptions)
  ...
  */
  def CFStringFindCharacterFromSet(theString : CFStringRef, theSet : CFCharacterSetRef, rangeToSearch : CFRange, searchOptions : CFStringCompareFlags, result : Ptr[CFRange])(using Zone): Boolean = 
    val __ptr_0: Ptr[CFRange] = alloc[CFRange](1)
    !(__ptr_0 + 0) = rangeToSearch
    __sn_wrap_cfstring_CFStringFindCharacterFromSet(theString, theSet, (__ptr_0 + 0), searchOptions, result)
  ...
  */
  def CFStringFindCharacterFromSet(theString : CFStringRef, theSet : CFCharacterSetRef, rangeToSearch : Ptr[CFRange], searchOptions : CFStringCompareFlags, result : Ptr[CFRange]): Boolean = 
    __sn_wrap_cfstring_CFStringFindCharacterFromSet(theString, theSet, rangeToSearch, searchOptions, result)
  ...
  */
  def CFStringFindWithOptions(theString : CFStringRef, stringToFind : CFStringRef, rangeToSearch : Ptr[CFRange], searchOptions : CFStringCompareFlags, result : Ptr[CFRange]): Boolean = 
    __sn_wrap_cfstring_CFStringFindWithOptions(theString, stringToFind, rangeToSearch, searchOptions, result)
  ...
  */
  def CFStringFindWithOptions(theString : CFStringRef, stringToFind : CFStringRef, rangeToSearch : CFRange, searchOptions : CFStringCompareFlags, result : Ptr[CFRange])(using Zone): Boolean = 
    val __ptr_0: Ptr[CFRange] = alloc[CFRange](1)
    !(__ptr_0 + 0) = rangeToSearch
    __sn_wrap_cfstring_CFStringFindWithOptions(theString, stringToFind, (__ptr_0 + 0), searchOptions, result)
  ...
  */
  def CFStringFindWithOptionsAndLocale(theString : CFStringRef, stringToFind : CFStringRef, rangeToSearch : Ptr[CFRange], searchOptions : CFStringCompareFlags, locale : CFLocaleRef, result : Ptr[CFRange]): Boolean = 
    __sn_wrap_cfstring_CFStringFindWithOptionsAndLocale(theString, stringToFind, rangeToSearch, searchOptions, locale, result)
  ...
  */
  def CFStringFindWithOptionsAndLocale(theString : CFStringRef, stringToFind : CFStringRef, rangeToSearch : CFRange, searchOptions : CFStringCompareFlags, locale : CFLocaleRef, result : Ptr[CFRange])(using Zone): Boolean = 
    val __ptr_0: Ptr[CFRange] = alloc[CFRange](1)
    !(__ptr_0 + 0) = rangeToSearch
    __sn_wrap_cfstring_CFStringFindWithOptionsAndLocale(theString, stringToFind, (__ptr_0 + 0), searchOptions, locale, result)
  ...
  */
  def CFStringGetBytes(theString : CFStringRef, range : Ptr[CFRange], encoding : CFStringEncoding, lossByte : UInt8, isExternalRepresentation : Boolean, buffer : Ptr[UInt8], maxBufLen : CFIndex, usedBufLen : Ptr[CFIndex]): CFIndex = 
    __sn_wrap_cfstring_CFStringGetBytes(theString, range, encoding, lossByte, isExternalRepresentation, buffer, maxBufLen, usedBufLen)
  ...
  */
  def CFStringGetBytes(theString : CFStringRef, range : CFRange, encoding : CFStringEncoding, lossByte : UInt8, isExternalRepresentation : Boolean, buffer : Ptr[UInt8], maxBufLen : CFIndex, usedBufLen : Ptr[CFIndex])(using Zone): CFIndex = 
    val __ptr_0: Ptr[CFRange] = alloc[CFRange](1)
    !(__ptr_0 + 0) = range
    __sn_wrap_cfstring_CFStringGetBytes(theString, (__ptr_0 + 0), encoding, lossByte, isExternalRepresentation, buffer, maxBufLen, usedBufLen)
  ...
  */
  def CFStringGetHyphenationLocationBeforeIndex(string : CFStringRef, location : CFIndex, limitRange : Ptr[CFRange], options : CFOptionFlags, locale : CFLocaleRef, character : Ptr[UTF32Char]): CFIndex = 
    __sn_wrap_cfstring_CFStringGetHyphenationLocationBeforeIndex(string, location, limitRange, options, locale, character)
  ...
  */
  def CFStringGetHyphenationLocationBeforeIndex(string : CFStringRef, location : CFIndex, limitRange : CFRange, options : CFOptionFlags, locale : CFLocaleRef, character : Ptr[UTF32Char])(using Zone): CFIndex = 
    ...
    __sn_wrap_cfstring_CFStringGetHyphenationLocationBeforeIndex(string, location, (__ptr_0 + 0), options, locale, character)
  ...
  */
  def CFStringGetLineBounds(theString : CFStringRef, range : Ptr[CFRange], lineBeginIndex : Ptr[CFIndex], lineEndIndex : Ptr[CFIndex], contentsEndIndex : Ptr[CFIndex]): Unit = 
    __sn_wrap_cfstring_CFStringGetLineBounds(theString, range, lineBeginIndex, lineEndIndex, contentsEndIndex)
  ...
  */
  def CFStringGetLineBounds(theString : CFStringRef, range : CFRange, lineBeginIndex : Ptr[CFIndex], lineEndIndex : Ptr[CFIndex], contentsEndIndex : Ptr[CFIndex])(using Zone): Unit = 
    val __ptr_0: Ptr[CFRange] = alloc[CFRange](1)
    !(__ptr_0 + 0) = range
    __sn_wrap_cfstring_CFStringGetLineBounds(theString, (__ptr_0 + 0), lineBeginIndex, lineEndIndex, contentsEndIndex)
  ...
  */
  def CFStringGetParagraphBounds(string : CFStringRef, range : CFRange, parBeginIndex : Ptr[CFIndex], parEndIndex : Ptr[CFIndex], contentsEndIndex : Ptr[CFIndex])(using Zone): Unit = 
    val __ptr_0: Ptr[CFRange] = alloc[CFRange](1)
    !(__ptr_0 + 0) = range
    __sn_wrap_cfstring_CFStringGetParagraphBounds(string, (__ptr_0 + 0), parBeginIndex, parEndIndex, contentsEndIndex)
  ...
  */
  def CFStringGetParagraphBounds(string : CFStringRef, range : Ptr[CFRange], parBeginIndex : Ptr[CFIndex], parEndIndex : Ptr[CFIndex], contentsEndIndex : Ptr[CFIndex]): Unit = 
    __sn_wrap_cfstring_CFStringGetParagraphBounds(string, range, parBeginIndex, parEndIndex, contentsEndIndex)
  ...
  */
  def CFStringGetRangeOfComposedCharactersAtIndex(theString : CFStringRef, theIndex : CFIndex)(__return : Ptr[CFRange]): Unit = 
    __sn_wrap_cfstring_CFStringGetRangeOfComposedCharactersAtIndex(theString, theIndex, __return)
  ...
  */
  def CFStringGetRangeOfComposedCharactersAtIndex(theString : CFStringRef, theIndex : CFIndex)(using Zone): CFRange = 
    val __ptr_0: Ptr[CFRange] = alloc[CFRange](1)
    __sn_wrap_cfstring_CFStringGetRangeOfComposedCharactersAtIndex(theString, theIndex, (__ptr_0 + 0))
    !(__ptr_0 + 0)
