...
object aliases:
  ...
  object CFBooleanRef:
    ...
    extension (v: CFBooleanRef) inline def value: Ptr[__CFBoolean] = v
  ...
  object CFNumberRef:
    ...
    extension (v: CFNumberRef) inline def value: Ptr[__CFNumber] = v
  ...
  object CFNumberType:
    ...
    extension (v: CFNumberType) inline def value: CFIndex = v
