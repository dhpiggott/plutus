...
object aliases:
  ...
  /** [bindgen] header:
    ...
    */
  opaque type CFAllocatorAllocateCallBack =
    CFuncPtr3[CFIndex, CFOptionFlags, Ptr[Byte], Ptr[Byte]]
  object CFAllocatorAllocateCallBack:
    given _tag: Tag[CFAllocatorAllocateCallBack] =
      Tag.materializeCFuncPtr3[CFIndex, CFOptionFlags, Ptr[Byte], Ptr[Byte]]
    inline def fromPtr(ptr: Ptr[Byte] | Ptr[?]): CFAllocatorAllocateCallBack =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr3[CFIndex, CFOptionFlags, Ptr[Byte], Ptr[Byte]]
    ): CFAllocatorAllocateCallBack = o
    extension (v: CFAllocatorAllocateCallBack)
      inline def value
          : CFuncPtr3[CFIndex, CFOptionFlags, Ptr[Byte], Ptr[Byte]] = v
      inline def toPtr: Ptr[?] = CFuncPtr.toPtr(v)

  /** [bindgen] header:
    * /Library/Developer/CommandLineTools/SDKs/MacOSX15.4.sdk/System/Library/Frameworks/CoreFoundation.framework/Versions/A/Headers/CFBase.h
    */
  opaque type CFAllocatorCopyDescriptionCallBack =
    CFuncPtr1[Ptr[Byte], CFStringRef]
  object CFAllocatorCopyDescriptionCallBack:
    given _tag: Tag[CFAllocatorCopyDescriptionCallBack] =
    ...
    ): CFAllocatorCopyDescriptionCallBack = o
  ...
  /** [bindgen] header:
    * /Library/Developer/CommandLineTools/SDKs/MacOSX15.4.sdk/System/Library/Frameworks/CoreFoundation.framework/Versions/A/Headers/CFBase.h
    */
  opaque type CFAllocatorDeallocateCallBack =
    CFuncPtr2[Ptr[Byte], Ptr[Byte], Unit]
  object CFAllocatorDeallocateCallBack:
    given _tag: Tag[CFAllocatorDeallocateCallBack] =
      Tag.materializeCFuncPtr2[Ptr[Byte], Ptr[Byte], Unit]
    inline def fromPtr(ptr: Ptr[Byte] | Ptr[?]): CFAllocatorDeallocateCallBack =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr2[Ptr[Byte], Ptr[Byte], Unit]
    ): CFAllocatorDeallocateCallBack = o
  ...
  /** [bindgen] header:
    * /Library/Developer/CommandLineTools/SDKs/MacOSX15.4.sdk/System/Library/Frameworks/CoreFoundation.framework/Versions/A/Headers/CFBase.h
    */
  opaque type CFAllocatorPreferredSizeCallBack =
    CFuncPtr3[CFIndex, CFOptionFlags, Ptr[Byte], CFIndex]
  object CFAllocatorPreferredSizeCallBack:
    given _tag: Tag[CFAllocatorPreferredSizeCallBack] =
      Tag.materializeCFuncPtr3[CFIndex, CFOptionFlags, Ptr[Byte], CFIndex]
    inline def fromPtr(
        ptr: Ptr[Byte] | Ptr[?]
    ): CFAllocatorPreferredSizeCallBack =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr3[CFIndex, CFOptionFlags, Ptr[Byte], CFIndex]
    ): CFAllocatorPreferredSizeCallBack = o
    extension (v: CFAllocatorPreferredSizeCallBack)
      inline def value: CFuncPtr3[CFIndex, CFOptionFlags, Ptr[Byte], CFIndex] =
        v
      inline def toPtr: Ptr[?] = CFuncPtr.toPtr(v)
  ...
  /** [bindgen] header:
    * /Library/Developer/CommandLineTools/SDKs/MacOSX15.4.sdk/System/Library/Frameworks/CoreFoundation.framework/Versions/A/Headers/CFBase.h
    */
  opaque type CFAllocatorReallocateCallBack =
    CFuncPtr4[Ptr[Byte], CFIndex, CFOptionFlags, Ptr[Byte], Ptr[Byte]]
  object CFAllocatorReallocateCallBack:
    given _tag: Tag[CFAllocatorReallocateCallBack] =
      Tag.materializeCFuncPtr4[Ptr[Byte], CFIndex, CFOptionFlags, Ptr[
        Byte
      ], Ptr[Byte]]
    inline def fromPtr(ptr: Ptr[Byte] | Ptr[?]): CFAllocatorReallocateCallBack =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr4[Ptr[Byte], CFIndex, CFOptionFlags, Ptr[Byte], Ptr[
          Byte
        ]]
    ): CFAllocatorReallocateCallBack = o
  ...
  object CFAllocatorReleaseCallBack:
    given _tag: Tag[CFAllocatorReleaseCallBack] =
      Tag.materializeCFuncPtr1[Ptr[Byte], Unit]
    inline def fromPtr(ptr: Ptr[Byte] | Ptr[?]): CFAllocatorReleaseCallBack =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr1[Ptr[Byte], Unit]
    ): CFAllocatorReleaseCallBack = o
  ...
  object CFAllocatorRetainCallBack:
    given _tag: Tag[CFAllocatorRetainCallBack] =
      Tag.materializeCFuncPtr1[Ptr[Byte], Ptr[Byte]]
    inline def fromPtr(ptr: Ptr[Byte] | Ptr[?]): CFAllocatorRetainCallBack =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr1[Ptr[Byte], Ptr[Byte]]
    ): CFAllocatorRetainCallBack = o
  ...
  object CFAllocatorTypeID:
    ...
    extension (v: CFAllocatorTypeID) inline def value: CUnsignedLongLong = v

  /** [bindgen] header:
    * /Library/Developer/CommandLineTools/SDKs/MacOSX15.4.sdk/System/Library/Frameworks/CoreFoundation.framework/Versions/A/Headers/CFBase.h
    */
  opaque type CFComparatorFunction =
    CFuncPtr3[Ptr[Byte], Ptr[Byte], Ptr[Byte], CFComparisonResult]
  object CFComparatorFunction:
    given _tag: Tag[CFComparatorFunction] = Tag
      .materializeCFuncPtr3[Ptr[Byte], Ptr[Byte], Ptr[Byte], CFComparisonResult]
    inline def fromPtr(ptr: Ptr[Byte] | Ptr[?]): CFComparatorFunction =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr3[Ptr[Byte], Ptr[Byte], Ptr[Byte], CFComparisonResult]
    ): CFComparatorFunction = o
    extension (v: CFComparatorFunction)
      inline def value
          : CFuncPtr3[Ptr[Byte], Ptr[Byte], Ptr[Byte], CFComparisonResult] = v
      inline def toPtr: Ptr[?] = CFuncPtr.toPtr(v)
  ...
  object CFNullRef:
    ...
    extension (v: CFNullRef) inline def value: Ptr[__CFNull] = v
  ...
  object CFPropertyListRef:
    ...
    extension (v: CFPropertyListRef) inline def value: CFTypeRef = v
...
object structs:
  ...
  /** [bindgen] header:
    * /Library/Developer/CommandLineTools/SDKs/MacOSX15.4.sdk/System/Library/Frameworks/CoreFoundation.framework/Versions/A/Headers/CFBase.h
    */
  opaque type CFAllocatorContext = CStruct9[
    CFIndex,
    Ptr[Byte],
  ...
  object CFAllocatorContext:
    given _tag: Tag[CFAllocatorContext] = Tag.materializeCStruct9Tag[
      CFIndex,
      Ptr[Byte],
      CFAllocatorRetainCallBack,
      CFAllocatorReleaseCallBack,
    ...
    def apply()(using Zone): Ptr[CFAllocatorContext] =
      scala.scalanative.unsafe.alloc[CFAllocatorContext](1)
    def apply(
        version: CFIndex,
        info: Ptr[Byte],
    ...
    )(using Zone): Ptr[CFAllocatorContext] =
      val ____ptr = apply()
    ...
    extension (struct: CFAllocatorContext)
      ...
      def release_=(value: CFAllocatorReleaseCallBack): Unit = !struct.at4 =
        value
      def copyDescription: CFAllocatorCopyDescriptionCallBack = struct._5
      def copyDescription_=(value: CFAllocatorCopyDescriptionCallBack): Unit =
        !struct.at5 = value
      def allocate: CFAllocatorAllocateCallBack = struct._6
      def allocate_=(value: CFAllocatorAllocateCallBack): Unit = !struct.at6 =
        value
      def reallocate: CFAllocatorReallocateCallBack = struct._7
      def reallocate_=(value: CFAllocatorReallocateCallBack): Unit =
        !struct.at7 = value
      def deallocate: CFAllocatorDeallocateCallBack = struct._8
      def deallocate_=(value: CFAllocatorDeallocateCallBack): Unit =
        !struct.at8 = value
      def preferredSize: CFAllocatorPreferredSizeCallBack = struct._9
      def preferredSize_=(value: CFAllocatorPreferredSizeCallBack): Unit =
        !struct.at9 = value
...
private[cfbase] object extern_functions:
  ...
  /** [bindgen] header:
    * /Library/Developer/CommandLineTools/SDKs/MacOSX15.4.sdk/System/Library/Frameworks/CoreFoundation.framework/Versions/A/Headers/CFBase.h
    */
  def CFAllocatorCreate(
      allocator: CFAllocatorRef,
      context: Ptr[CFAllocatorContext]
  ): CFAllocatorRef = extern

  /** [bindgen] header:
    * /Library/Developer/CommandLineTools/SDKs/MacOSX15.4.sdk/System/Library/Frameworks/CoreFoundation.framework/Versions/A/Headers/CFBase.h
    */
  def CFAllocatorDeallocate(allocator: CFAllocatorRef, ptr: Ptr[Byte]): Unit =
    extern

  /** [bindgen] header:
    * /Library/Developer/CommandLineTools/SDKs/MacOSX15.4.sdk/System/Library/Frameworks/CoreFoundation.framework/Versions/A/Headers/CFBase.h
    */
  def CFAllocatorGetContext(
      allocator: CFAllocatorRef,
      context: Ptr[CFAllocatorContext]
  ): Unit = extern
  ...
  /** [bindgen] header:
    * /Library/Developer/CommandLineTools/SDKs/MacOSX15.4.sdk/System/Library/Frameworks/CoreFoundation.framework/Versions/A/Headers/CFBase.h
    */
  def CFAllocatorGetPreferredSizeForSize(
      allocator: CFAllocatorRef,
      size: CFIndex,
      hint: CFOptionFlags
  ): CFIndex = extern
  ...
  /** [bindgen] header:
    * /Library/Developer/CommandLineTools/SDKs/MacOSX15.4.sdk/System/Library/Frameworks/CoreFoundation.framework/Versions/A/Headers/CFBase.h
    */
  def CFAllocatorReallocateBytes(
      allocator: CFAllocatorRef,
      ptr: Ptr[Byte],
      newsize: CFIndex,
      hint: CFOptionFlags
  ...
  /** [bindgen] header:
    * /Library/Developer/CommandLineTools/SDKs/MacOSX15.4.sdk/System/Library/Frameworks/CoreFoundation.framework/Versions/A/Headers/CFBase.h
    */
  def CFAllocatorReallocateTyped(
      allocator: CFAllocatorRef,
      ptr: Ptr[Byte],
      newsize: CFIndex,
      descriptor: CFAllocatorTypeID,
  ...
  private[cfbase] def __sn_wrap_cfbase_CFRangeMake(
      loc: CFIndex,
      len: CFIndex,
      __return: Ptr[CFRange]
  ): Unit = extern

  private[cfbase] def __sn_wrap_cfbase___CFRangeMake(
      loc: CFIndex,
      len: CFIndex,
      __return: Ptr[CFRange]
  ): Unit = extern
